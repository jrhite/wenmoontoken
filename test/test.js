...
describe("WenMoonBank", function () {
  ...
  describe('approve() / allowance() checks', function () {
    xit('WenMoonBank is not approved to spend WenMoonTokens on a user\'s behalf', async function () {
    ...
    xit('After calling approve() WenMoonBank is approved to spend WenMoonTokens on a user\'s behalf',
      async function () {
  ...
  describe('deposit()', function () {
    xit('transfers WMT from user account to bank contract account', async function () {
  ...
  describe('withdraw()', function () {
    xit('transfers WMT from bank contract account to user account', async function () {
